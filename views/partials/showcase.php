    ...
    <div class="container mx-auto text-center z-10">
        ...
        <form class="mb-4 block mx-5 md:mx-auto">
            <input
                ...
                class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none rounded-lg"
            />
            <input
                type="text"
                name="location"
            ...
            />
            <button
                class="w-full md:w-auto bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 focus:outline-none rounded-lg"
            >
